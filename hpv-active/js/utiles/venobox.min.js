        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                obj.on('click', function(e){
                    ...
                    vbheader = '<div class="vbox-title"></div><div class="vbox-num"><span>0</span>/<span>0</span></div><div class="vbox-close">' + option.htmlClose + '</div>';
                ...
                function checknav(){
                    ...
                    if (items.length > 1) {
                      ...
                      blocknum.html('<span>' + gallIndex + '</span> / <span>' + items.length + '</span>');
                    } else {
                      gallIndex = 1;
                    }
                    if (numeratio === true) {
